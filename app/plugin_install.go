...
func (a *App) InstallPluginFromData(data model.PluginEventData) {
	mlog.Info(fmt.Sprintf("InstallPluginFromData. ID: %v, Path: %v", data.PluginId, data.PluginPath))
}

func (a *App) RemovePluginFromData(data model.PluginEventData) {
	mlog.Info(fmt.Sprintf("RemovePluginFromData. ID: %v, Path: %v", data.PluginId, data.PluginPath))
}
